...
4. If documentation is requested, use [architecture](./references/architecture.md) and [review-checklist](./references/review-checklist.md).
5. If a diagram is requested, use [mermaid-cheatsheet](./references/mermaid-cheatsheet.md).
